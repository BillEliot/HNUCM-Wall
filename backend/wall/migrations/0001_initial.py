# Generated by Django 3.0.1 on 2021-03-05 11:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.CharField(choices=[('手太阴肺经', '手太阴肺经'), ('手阳明大肠经', '手阳明大肠经'), ('足阳明胃经', '足阳明胃经'), ('足太阴脾经', '足太阴脾经'), ('手少阴心经', '手少阴心经'), ('手太阳小肠经', '手太阳小肠经'), ('足太阳膀胱经', '足太阳膀胱经'), ('足少阴肾经', '足少阴肾经'), ('手厥阴心包经', '手厥阴心包经'), ('手少阳三焦经', '手少阳三焦经'), ('足少阳胆经', '足少阳胆经'), ('足厥阴肝经', '足厥阴肝经'), ('任脉', '任脉'), ('督脉', '督脉')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Article',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=30)),
                ('content', models.TextField()),
                ('_type', models.CharField(choices=[('新闻', '新闻'), ('通知', '通知'), ('招标公告', '招标公告'), ('中标公告', '中标公告'), ('瓜', '瓜')], default='新闻', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('_type', models.CharField(choices=[('thumbsUp', 'thumbsUp'), ('comment', 'comment')], max_length=10)),
                ('_from', models.CharField(choices=[('love', 'love'), ('lose', 'lose'), ('deal', 'deal'), ('help', 'help'), ('article', 'article')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Deal')),
                ('lose', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Lose')),
                ('love', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Love')),
            ],
        ),
        migrations.CreateModel(
            name='Help',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_file', models.FileField(upload_to='file/')),
                ('_type', models.CharField(choices=[('word', 'word'), ('excel', 'excel'), ('ppt', 'ppt'), ('pdf', 'pdf')], max_length=20)),
                ('match', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Match')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('content', models.TextField()),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('_help', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Help')),
                ('article', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Article')),
                ('deal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Deal')),
                ('lose', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Lose')),
                ('love', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wall.Love')),
